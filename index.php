...
function carouse3() {
  ...
  <img class="mySlide w3-animate-opacity" src="slider_image/e1.jpg" style="width:100%" draggable="false">
  <img class="mySlide w3-animate-opacity" src="slider_image/e2.jpg" style="width:100%" draggable="false">
  <img class="mySlide w3-animate-opacity" src="slider_image/e3.jpg" style="width:100%" draggable="false">
  <img class="mySlide w3-animate-opacity" src="slider_image/e4.jpg" style="width:100%" draggable="false">
   <img class="mySlide w3-animate-opacity" src="slider_image/e5.jpg" style="width:100%" draggable="false">
  <img class="mySlide w3-animate-opacity " src="slider_image/e6.jpg" style="width:100%" draggable="false">
...
<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<div class="w3-content w3-display-container">
  <img class="mySlid w3-animate-zoom" src="slider_image/d1.jpg" style="width:100%" draggable="false">
  <img class="mySlid w3-animate-zoom" src="slider_image/d2.jpg" style="width:100%" draggable="false">
  <img class="mySlid w3-animate-zoom" src="slider_image/d3.jpg" style="width:100%" draggable="false">
  <img class="mySlid w3-animate-zoom" src="slider_image/d4.jpg" style="width:100%" draggable="false">
  <img class="mySlid w3-animate-zoom" src="slider_image/d5.jpg" style="width:100%" draggable="false">
  <img class="mySlid w3-animate-zoom" src="slider_image/d6.jpg" style="width:100%" draggable="false">
